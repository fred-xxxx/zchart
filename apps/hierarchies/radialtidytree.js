...
let rtt = new RadialTidytree()
window.Draw.addAppListener("Radial Tidy Tree", function (data) {
    rtt.SetData(data)
    rtt.ReDraw()
})

window.Draw.addSelectNodeListener("Radial Tidy Tree", function (node) {
    rtt.SetSelectNode(node)
    rtt.ReDraw()
})

window.Draw.addNewFileListener("Radial Tidy Tree", function (node) {
    return rtt.newFile()
})
